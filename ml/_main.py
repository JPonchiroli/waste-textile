...
def process_file(input_path, output_dir):
    ...
    plt.title('Produção Total: Histórico vs. Previsão (12 Meses)', fontsize=16)
    ...
    plt.title('Previsão de Eficiência (12 Meses)', fontsize=16)
    plt.ylabel('Eficiência (kg/h)')
    plt.xlabel('Mês')
    plt.xticks(rotation=45)
    plt.tight_layout()
    ...
    plt.title('Previsão de Horas Operacionais (12 Meses)', fontsize=16)
    plt.ylabel('Horas')
    plt.xlabel('Mês')
    plt.xticks(rotation=45)
    plt.tight_layout()
